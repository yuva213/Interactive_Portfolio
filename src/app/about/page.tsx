...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "yuvarajpro213@gmail",
    href: "mailto:yuvarajpro213@gmail.com",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Yuvaraj S</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Yuvaraj, a Fullstack developer passionate about
              creating meaningful digital experiences. With a strong background in MERN 
              stack development, I thrive on turning ideas into reality through coding
              and design. My journey began with a fascination for technology and
              a drive to make a positive impact.
            </p>
            <p className="mb-10">
              When I&apos;m not coding, you can find me exploring Web3 and AI, 
              participating in hackathons, or brainstorming my next project with a coffee.
            </p>
